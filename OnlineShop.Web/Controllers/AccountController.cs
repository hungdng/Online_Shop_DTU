    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    MailHelper.SendMail(model.Email, "Activate Online Shop Account", "Activate by <a href=\"" + callbackUrl + "\">click here</a>");
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await UserManager.SendEmailAsync(user.Id, "Reset password", "To reset your passsword, please <a href=\"" + callbackUrl + "\"> click here</a>");
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (confirmUser != null)
                {
                    ModelState.AddModelError("", "Email or account existed");
                    Thread.Sleep(1000);
                    return View(model);
                }
                var user = new AppUser { UserName = model.Email, Email = model.Email, FullName = model.Email };
